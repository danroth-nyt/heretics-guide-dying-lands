...
export const roomShapeTable: Table = {
  name: 'Room Shape (d12)',
  entries: [
    { roll: 1, result: 'Square' },
    { roll: 2, result: 'Rectangle' },
    { roll: 3, result: 'Circle' },
    { roll: 4, result: 'Oval' },
    { roll: 5, result: 'Triangle' },
    { roll: 6, result: 'Irregular polygon' },
    { roll: 7, result: 'Natural cavern' },
    { roll: 8, result: 'Split-level chamber' },
    { roll: 9, result: 'Long corridor-like room' },
    { roll: 10, result: 'Star-shaped or branching' },
    { roll: 11, result: 'Winding organic shape' },
    { roll: 12, result: 'Ruin collapse shape (partial room)' },
  ],
};

export const roomSoundsTable: Table = {
  name: 'Room Sounds (d20)',
  entries: [
    { roll: 1, result: 'Dripping water' },
    { roll: 2, result: 'Soft scratching' },
    { roll: 3, result: 'Heavy breathing' },
    { roll: 4, result: 'Chains rattling' },
    { roll: 5, result: 'Faint chanting' },
    { roll: 6, result: 'Growling' },
    { roll: 7, result: 'Insect hum' },
    { roll: 8, result: 'Whispering' },
    { roll: 9, result: 'Stone shifting' },
    { roll: 10, result: 'Steps receding' },
    { roll: 11, result: 'Pattering' },
    { roll: 12, result: 'Distant scream' },
    { roll: 13, result: 'Gear clicking' },
    { roll: 14, result: 'Gurgling' },
    { roll: 15, result: 'Wind through cracks' },
    { roll: 16, result: 'Wet sloshing' },
    { roll: 17, result: 'Bones clattering' },
    { roll: 18, result: 'Nothing but your own movement' },
    { roll: 19, result: 'Deep rumble' },
    { roll: 20, result: 'A voice saying something unintelligible' },
  ],
};

export const roomSmellsTable: Table = {
  name: 'Room Smells (d20)',
  entries: [
    { roll: 1, result: 'Rot' },
    { roll: 2, result: 'Mold' },
    { roll: 3, result: 'Sulfur' },
    { roll: 4, result: 'Metallic blood' },
    { roll: 5, result: 'Ammonia' },
    { roll: 6, result: 'Incense' },
    { roll: 7, result: 'Lantern oil' },
    { roll: 8, result: 'Wet fur' },
    { roll: 9, result: 'Stale air' },
    { roll: 10, result: 'Stone dust' },
    { roll: 11, result: 'Cold ashes' },
    { roll: 12, result: 'Fresh earth' },
    { roll: 13, result: 'Burnt wood' },
    { roll: 14, result: 'Strange sweetness' },
    { roll: 15, result: 'Sickly decay' },
    { roll: 16, result: 'Vinegar' },
    { roll: 17, result: 'Sewage' },
    { roll: 18, result: 'Chemical stench' },
    { roll: 19, result: 'Perfumed air' },
    { roll: 20, result: 'Odorless void' },
  ],
};

export const roomEncounterTable: Table = {
  name: 'Room Encounter (d20)',
  entries: [
    { roll: 1, result: 'Lone beast' },
    { roll: 2, result: 'Small group of scavengers' },
    { roll: 3, result: 'Cultists at ritual' },
    { roll: 4, result: 'Undead' },
    { roll: 5, result: 'Aggressive pests' },
    { roll: 6, result: 'Prisoner or lost wanderer' },
    { roll: 7, result: 'Sorcerous abomination' },
    { roll: 8, result: 'Demon or spirit' },
    { roll: 9, result: 'Guard animal' },
    { roll: 10, result: 'Lone creature' },
    { roll: 11, result: 'Swarm' },
    { roll: 12, result: 'Living fungus' },
    { roll: 13, result: 'Tainted humanoid' },
    { roll: 14, result: 'Construct' },
    { roll: 15, result: 'Arcane guardian' },
    { roll: 16, result: 'Starved creature' },
    { roll: 17, result: 'Cursed statue animate' },
    { roll: 18, result: 'Lurker above/below' },
    { roll: 19, result: 'Invisible stalker' },
    { roll: 20, result: 'Boss-level threat' },
  ],
};

export const roomLootTable: Table = {
  name: 'Room Loot (d20)',
  entries: [
    { roll: 1, result: 'Coins' },
    { roll: 2, result: 'Trinket' },
    { roll: 3, result: 'Valuable scrap' },
    { roll: 4, result: 'Minor relic' },
    { roll: 5, result: 'Useful tool' },
    { roll: 6, result: 'Potion' },
    { roll: 7, result: 'Scroll fragment' },
    { roll: 8, result: 'Weapon' },
    { roll: 9, result: 'Armor piece' },
    { roll: 10, result: 'Jewelry' },
    { roll: 11, result: 'Gemstone' },
    { roll: 12, result: 'Oddity' },
    { roll: 13, result: 'Artifact piece' },
    { roll: 14, result: 'Ritual component' },
    { roll: 15, result: 'Cursed object' },
    { roll: 16, result: 'Map scrap' },
    { roll: 17, result: 'Rare material' },
    { roll: 18, result: 'Healing items' },
    { roll: 19, result: 'Valuable book' },
    { roll: 20, result: 'Something unsettlingly important' },
  ],
};
